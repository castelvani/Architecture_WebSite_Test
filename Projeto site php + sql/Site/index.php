...
<html lang="en">
  ...
  <a href="Cadastro.php">
      <button type="button" class="btn btn-secondary btn-sm">Cadastrar</button></a>
      <span class="site-heading-upper text-primary mb-3">Construção limpa e ecológica</span>
      <span class="site-heading-lower">Clean Construction</span>
    </h1>
    ...
    <section class="page-section clearfix">
      <div class="container">
        <div class="intro">
            <img class="intro-img img-fluid mb-3 mb-lg-0 rounded" src="img/imperador.jpg" alt="Edificio">
    ...
    <footer class="footer text-faded text-center py-5">
      <div class="container">
        <p class="m-0 small">Clean Construction&copy; Rua Barão, 25, Jardim Ivete</p>
      </div>
    </footer>
